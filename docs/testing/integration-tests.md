...
> | `internal/persistence/postgres/diplomacy_integration_test.go` | 14 | PostgreSQL 16 real |
...
>
> Los 44 pasan con el detector de carreras activo. **No se ejecutan con Docker**: la máquina de
